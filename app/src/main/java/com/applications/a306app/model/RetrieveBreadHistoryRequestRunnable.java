...
public class RetrieveBreadHistoryRequestRunnable implements Runnable{
    ...
    public RetrieveBreadHistoryRequestRunnable(Socket mySocket,int type) {
    ...
    public void run() {
        ...
        outputClient = XMLCreator.createRetrieveBreadXML(type,UsersDB.getHostUser().getLogin());
