...
public class UserRegistrationResponceRunnable implements Runnable {
    ...
    public UserRegistrationResponceRunnable(Socket inputSocket, Handler handler) {
    ...
    public void run() {
        ...
        try {
            while ((inputClient = fromServerReader.readLine()) != null) {
                ...
                if(messageType==com.applications.a306app.model.HandleServer.HandleServerResponseConstants.SETREGISTRATIONMESSAGE) {
                    bundle.putString(XMLConstants.TAGS_USER_REGISTRATION,resultOfXMLParsing.get(0));
                }
