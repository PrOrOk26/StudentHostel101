...
public class InsertGarbageResponceRunnable implements Runnable{
    ...
    public InsertGarbageResponceRunnable(Socket inputSocket, Handler handler) {
    ...
    public void run() {
        ...
        try {
            while ((inputClient = fromServerReader.readLine()) != null) {
                ...
                if(messageType== HandleServer.HandleServerResponseConstants.SETINSERTGARBAGEMESSAGE) {

                    bundle.putString(XMLConstants.TAGS_INSERT_GARBAGE,resultString);
