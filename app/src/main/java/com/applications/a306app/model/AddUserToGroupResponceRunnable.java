...
public class AddUserToGroupResponceRunnable implements Runnable {
    ...
    public AddUserToGroupResponceRunnable(Socket inputSocket, Handler handler) {
    ...
    public void run() {
        ...
        try {
            while ((inputClient = fromServerReader.readLine()) != null) {
                ...
                if(messageType== HandleServer.HandleServerResponseConstants.SETGROUPINVITATIONMESSAGE)
                    bundle.putString(XMLConstants.TAGS_GROUP_ADD_USER,resultString);
