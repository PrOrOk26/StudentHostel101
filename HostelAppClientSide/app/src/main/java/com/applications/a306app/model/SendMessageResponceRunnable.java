...
public class SendMessageResponceRunnable implements Runnable {
    ...
    public SendMessageResponceRunnable(Socket inputSocket, Handler handler) {
    ...
    public void run() {
        ...
        try {
            while ((inputClient = fromServerReader.readLine()) != null) {
                ...
                if(messageType== HandleServer.HandleServerResponseConstants.SETSENDCHATMESSAGE) {

                        bundle.putString(XMLConstants.TAGS_SEND_MAIN_CHAT_MESSAGE,resultString);
