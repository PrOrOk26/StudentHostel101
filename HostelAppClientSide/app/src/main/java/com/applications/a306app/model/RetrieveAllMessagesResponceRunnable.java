...
public class RetrieveAllMessagesResponceRunnable implements Runnable {
    ...
    public RetrieveAllMessagesResponceRunnable(Socket inputSocket, Handler handler) {
    ...
    public void run() {
        ...
        try {
            while ((inputClient = fromServerReader.readLine()) != null) {
                ...
                MessageDB.initializeChatMessageDB(resultOfXMLParsing);

                MessageDB.setChatInitialization(true);
                ...
                if(messageType== HandleServer.HandleServerResponseConstants.SETRETRIEVEALLCHATMESSAGE) {

                    bundle.putString(XMLConstants.TAGS_RETRIEVE_ALL_CHAT,"success");
