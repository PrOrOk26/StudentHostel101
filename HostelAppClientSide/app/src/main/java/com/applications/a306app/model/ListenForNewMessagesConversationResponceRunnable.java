...
public class ListenForNewMessagesConversationResponceRunnable implements Runnable {
    ...
    public ListenForNewMessagesConversationResponceRunnable(Socket inputSocket, Handler handler) {
    ...
    public void run() {
        try {
            ...
            while ((inputClient = fromServerReader.readLine()) != null) {
                ...
                if (messageType == HandleServer.HandleServerResponseConstants.SETGETRECENTCONVERSATIONMESSAGES) {
