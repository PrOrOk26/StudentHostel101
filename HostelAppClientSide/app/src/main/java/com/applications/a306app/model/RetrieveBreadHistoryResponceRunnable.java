...
public class RetrieveBreadHistoryResponceRunnable implements Runnable{
    ...
    public RetrieveBreadHistoryResponceRunnable(Socket inputSocket, Handler handler) {
    ...
    public void run() {
        ...
        try {
            while ((inputClient = fromServerReader.readLine()) != null) {
                ...
                {
                    buffAct=new UserActivity(HandleServer.HandleServerResponseConstants.SETGETBREADHISTORYMESSAGE);
                ...
                if(messageType== HandleServer.HandleServerResponseConstants.SETGETBREADHISTORYMESSAGE) {

                    bundle.putString(XMLConstants.TAGS_REQUEST_BREAD_HISTORY,XMLConstants.TAGS_REQUEST_BREAD_HISTORY);
