...
public class InsertBreadResponceRunnable implements Runnable{
    ...
    public InsertBreadResponceRunnable(Socket inputSocket, Handler handler) {
    ...
    public void run() {
        ...
        try {
            while ((inputClient = fromServerReader.readLine()) != null) {
                ...
                if(messageType== HandleServer.HandleServerResponseConstants.SETINSERTBREADMESSAGE) {

                    bundle.putString(XMLConstants.TAGS_INSERT_BREAD,resultString);
